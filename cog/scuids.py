    ...
    async def callback(self, Interaction: discord.Interaction):
     async with enka.EnkaAPI() as api:
       try:
        ...
        draw.text((842, 104), (f"{weapon.WeaponStat.value}{'%' if weapon.WeaponStat.type == DigitType.PERCENT else ''}"), font=font, fill=(255, 255, 255))#atk
        for substate in weapon.WeaponStat: #dòng chính
