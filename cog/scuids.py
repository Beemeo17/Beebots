    ...
    async def callback(self, Interaction: discord.Interaction):
     async with enka.EnkaAPI() as api:
       try:
        ...
        draw.text((688, 250), (f"HP: {int(charactert.stats[2].value)}"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 285), (f"Tân Công: {int(charactert.stats[5].value)}"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 325), (f"Phòng Ngự: {int(charactert.stats[8].value)}"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 365), (f"Tinh Thông Nguyên Tố: {int(charactert.stats[26].value)}"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 405),(f"Tỉ Lệ Bạo: {charactert.stats[20].value* 100:.0f}%"), font=font, fill=(255, 255, 255))
        ...
        draw.text((688, 445),(f"Sát Thương Bạo: {charactert.stats[22].value* 100:.0f}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 485),(f"Hiệu Quả Nạp: {charactert.stats[23].value* 100:.0f}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 525),(f"trị liệu: {int(charactert.stats[26].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        #stnt
        draw.text((710, 578),(f"{int(charactert.stats[30].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((830, 578),(f"{int(charactert.stats[44].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((940, 578),(f"{int(charactert.stats[45].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((1050, 578),(f"{int(charactert.stats[41].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((710, 638),(f"{int(charactert.stats[43].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((830, 638),(f"{int(charactert.stats[42].value * 100)}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((940, 638),(f"{int(charactert.stats[40].value * 100)}%"), font=fontt, fill=(255, 255, 255)) 
        ...
        draw.text((1050, 638),(f"{int(charactert.stats[46].value * 100)}%"), font=fontt, fill=(255, 255, 255))
