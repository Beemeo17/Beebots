    ...
    async def callback(self, Interaction: discord.Interaction):
     async with enka.EnkaAPI(lang=Language.VIETNAMESE) as api:
       try:
        ...
        draw.text((688, 405),(f"Tỉ Lệ Bạo: {float(characterp[FightProp.FIGHT_PROP_CRITICAL].formatted_value.rstrip('%'))}%"), font=font, fill=(255, 255, 255))
        ...
        draw.text((688, 445),(f"Sát Thương Bạo: {float(characterp[FightProp.FIGHT_PROP_CRITICAL_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 485),(f"Hiệu Quả Nạp: {float(characterp[FightProp.FIGHT_PROP_CHARGE_EFFICIENCY].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 525),(f"trị liệu: {float(characterp[FightProp.FIGHT_PROP_HEAL_ADD].formatted_value)}"), font=fontt, fill=(255, 255, 255))
        ...
        #stnt
        draw.text((710, 578),(f"{float(characterp[FightProp.FIGHT_PROP_PHYSICAL_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((830, 578),(f"{float(characterp[FightProp.FIGHT_PROP_WIND_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((940, 578),(f"{float(characterp[FightProp.FIGHT_PROP_ROCK_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((1050, 578),(f"{float(characterp[FightProp.FIGHT_PROP_ELEC_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((710, 638),(f"{float(characterp[FightProp.FIGHT_PROP_GRASS_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((830, 638),(f"{float(characterp[FightProp.FIGHT_PROP_WATER_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((940, 638),(f"{float(characterp[FightProp.FIGHT_PROP_FIRE_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255)) 
        ...
        draw.text((1050, 638),(f"{float(characterp[FightProp.FIGHT_PROP_ICE_ADD_HURT].formatted_value.rstrip('%'))}%"), font=fontt, fill=(255, 255, 255))
           ...
           for substate in artifact.sub_stats:
            if substate.name == "Tỷ Lệ Bạo Kích" or substate.name == "ST Bạo Kích":
              if substate.name == "Tỷ Lệ Bạo Kích":
                crit_rate = float(substate.formatted_value.rstrip('%'))
              elif substate.name == "ST Bạo Kích":
                crit_dmg = float(substate.formatted_value.rstrip('%'))
