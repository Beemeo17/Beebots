    ...
    async def callback(self, Interaction: discord.Interaction):
     async with enka.EnkaAPI(lang=Language.VIETNAMESE) as api:
       try:
        ...
        draw.text((688, 485),(f"Hiệu Quả Nạp: {int(characterp[FightProp.FIGHT_PROP_CHARGE_EFFICIENCY].value):.0f}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((688, 525),(f"trị liệu: {int(characterp[FightProp.FIGHT_PROP_HEAL_ADD].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        #stnt
        draw.text((710, 578),(f"{int(characterp[FightProp.FIGHT_PROP_PHYSICAL_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((830, 578),(f"{int(characterp[FightProp.FIGHT_PROP_WIND_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((940, 578),(f"{int(characterp[FightProp.FIGHT_PROP_ROCK_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((1050, 578),(f"{int(characterp[FightProp.FIGHT_PROP_ELEC_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((710, 638),(f"{int(characterp[FightProp.FIGHT_PROP_GRASS_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((830, 638),(f"{int(characterp[FightProp.FIGHT_PROP_WATER_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        draw.text((940, 638),(f"{int(characterp[FightProp.FIGHT_PROP_FIRE_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255)) 
        ...
        draw.text((1050, 638),(f"{int(characterp[FightProp.FIGHT_PROP_ICE_ADD_HURT].value )}%"), font=fontt, fill=(255, 255, 255))
        ...
        for artifact in charactert.artifacts:
          ...
          for substate in artifact.sub_stats:
            ...
            if substate.value.is_integer():
                draw.text((x_tdv_stats, y_tdv_stats1), (f"{name_sst} {substate.value}"), font=ImageFont.truetype("zh-cn.ttf", 19), fill=(255, 255, 255))
            else:
                draw.text((x_tdv_stats, y_tdv_stats1), (f"{name_sst} {(substate.value / 100):.1f}"), font=ImageFont.truetype("zh-cn.ttf", 19), fill=(255, 255, 255))
